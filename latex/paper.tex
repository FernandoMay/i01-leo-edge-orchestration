...
\begin{table}[h]
\centering
\caption{Performance Comparison (72 satellites, 955 tasks)}
\begin{tabular}{lccc}
\toprule
Method & Avg Latency (s) & Deadline Met (\%) & Exec Time (s) \\
\midrule
XING & 31.24 & 37.2\% & 0.037 \\
PSO & 0.41 & 98.2\% & 0.458 \\
GA & 0.42 & 98.1\% & 1.820 \\
\bottomrule
\end{tabular}
...
XING achieves the fastest execution time (0.037s) due to its greedy cognitive routing, while PSO and GA achieve higher deadline compliance through global optimization. The tradeoff demonstrates that XING's strength lies in real-time responsiveness rather than全局 optimality.

\subsection{Execution Time Analysis}

XING executes 12x faster than PSO and 49x faster than GA, making it suitable for real-time 6G edge orchestration where decisions must be made in milliseconds.

\subsection{Scalability Analysis}

We evaluated performance as the constellation scales from 12 to 144 satellites. XING maintains consistent execution time advantage across all scales.
